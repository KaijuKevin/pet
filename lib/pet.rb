class Pet
  ...
  define_method(:check) do
    values = [pet_name(), food_level(), sleep_level(), activity_level()]
  end

  define_singleton_method(:feed) do |food|
    food_table = {
      "apple" => 1,
      "banana" => 2
    }
  ...
  define_singleton_method(:play) do |activity|
    play_table = {
      "fetch" => 2,
      "race" => 3
    }
